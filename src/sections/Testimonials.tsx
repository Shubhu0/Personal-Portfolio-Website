...
export const TestimonialsSection = () => {
  return (
    <div className="py-16 lg:py-24">
      ...
      <SectionHeader 
      eyebrow="Referrals"
      title="Previous Colleagues"
      description="See what my colleagues have to say about my work" 
      />
        ...
        py-4 -my-4">
          <div className="flex gap-8 pr-8 flex-none
           animate-move-left [animation-duration:60s] hover:[animation-play-state:paused]">
              ...
              {testimonials.map((testimonial) => (
                ...
                hover:-rotate-3 transition duration-300">
                  ...
                  <div className="flex gap-4 items-center">
                    <div className="size-14 bg-[#8ba888] inline-flex 
